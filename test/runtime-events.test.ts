...
test("research-native runtime events round-trip through JSONL", async () => {
  ...
  try {
    ...
    const events: Idea2RepoEvent[] = [
      ...
      { type: "survey.updated", run_id: "run-1", path: "docs/relative_work/survey.md", verified_papers: 1, clusters: 2, baselines: 1, datasets: 1, metrics: 1, timestamp: "2026-05-11T00:00:02Z" },
