...
export const researchStages: ResearchStageDefinition[] = [
  {
    ...
    deterministic: false,
    artifactPaths: [
      "docs/idea/raw_idea.md",
      "docs/idea/idea_brief.md",
      "docs/idea/idea_brief.json",
      "docs/idea/optimized_research_direction.md",
      "docs/idea/optimized_idea.md",
      "docs/idea/research_question.md",
      "docs/idea/assumptions.md"
    ]
  },
  {
    id: "search_planning",
