...
export type Idea2RepoEvent =
  ...
  | { type: "approval.requested"; run_id: string; approval_id: string; stage_id?: string; action: string; risk: string; paper_options?: Array<{ id: string; title: string }>; timestamp: string }
